...
<head>
    ...
    <link href="{{secure_asset('theme/assets/dist/css/bootstrap-datepicker.css')}}" rel="stylesheet" type="text/css" />

    <link href="{{secure_asset('theme/assets/select2/dist/css/select2.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{secure_asset('theme/assets/css/custom.css')}}" rel="stylesheet" type="text/css" />
