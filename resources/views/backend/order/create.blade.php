                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-box" style="box-shadow: 0 25px 35px 0 lightgrey">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">Tax (18%)</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">Total Amount</label>
            ...
            $(document).ready(function() {
                ...
                function dynamic_field(number) {
                    ...
                    html +=
                        `<td>
                          ...
                          <input type="hidden" name="total_quantity" class="form-control tqty" />
                          </td>`;
                    html += `<td>
                        <input type="text" name="" class="form-control price" readonly />
                      </td>`;
                    html += '<td>₦<span class="total">0</span></td>';
                ...
                function calculation(discount, paid) {
                    ...
                    if (sub_total > 0) {
                        ...
                        var total_amount = tax + sub_total;
                        $('#total_amount').val(Math.round(total_amount));

                        if (discountAmount > 0) {
                            var total_amount = total_amount - discountAmount;
                        ...
                        if (paid > 0) {
                            total_amount = Math.round(total_amount - paid);
                ...
                $('#paid').keyup(function() {
                    ...
                    calculation(discountAmount, paid);
                });
